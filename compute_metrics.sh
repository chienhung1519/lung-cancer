...
python compute_metrics.py \
  --predictions_file outputs/Llmama-3.1-8B-Instruct/lora/predict_ntu/generated_predictions.jsonl \
  --outputs_dir outputs/Llmama-3.1-8B-Instruct/lora/predict_ntu \
  --model_type llama

python compute_metrics.py \
  --predictions_file outputs/Llmama-3.1-8B-Instruct/lora/predict_tmu/generated_predictions.jsonl \
  --outputs_dir outputs/Llmama-3.1-8B-Instruct/lora/predict_tmu \
  --model_type llama